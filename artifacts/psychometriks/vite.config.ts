    ...
    rollupOptions: {
      output: {
        manualChunks(id) {
          ...
          // Solo extraemos los paquetes más pesados sin crear dependencias circulares.
          // NO hacemos un catch-all "vendor" — Vite maneja el resto automáticamente.
          if (
          ...
          return undefined; // Vite decide el resto — sin circulares
        },
      },
    },
  },
