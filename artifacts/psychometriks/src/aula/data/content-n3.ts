...
export const contentN3: Record<string, AulaModuleContent> = {
"smart-money-intro": {
  sections: [
    {
      type: "amd-chart",
...
"liquidez": {
  sections: [
    {
      type: "sweep-destroy",
      title: "Sweep & Destroy — Barrida de Liquidez",
    },
    {
      type: "liquidity-absorption",
      title: "Absorción de Liquidez Institucional",
    },
    {
      type: "liquidity-map-chart",
      title: "Mapa de Liquidez — Zonas BSL y SSL",
    },
    {
...
"ipda": {
  sections: [
    {
      type: "ipda-chart",
      title: "IPDA — Rangos de Referencia Institucional",
    },
    {
