...
export default function IaSignalsConfirmadas() {
  ...
  async function fetchSignals() {
    ...
    setSigError("");
    try {
      const r = await fetch("/api/ia-signals");
        ...
        <div className="flex items-center justify-between py-6 flex-wrap gap-4">
          <div>
            ...
            <h1 className="font-bebas text-4xl md:text-5xl">
              SEÑALES <span className="text-[#00e5ff]">CONFIRMADAS</span>
              <span className="font-space text-sm text-[#7ab3c8] ml-3 tracking-[0.1em]">IA TRADING</span>
            </h1>
          </div>
          <div className="flex items-center gap-4 flex-wrap">
            <div className="flex flex-col items-end gap-0.5">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-sharetech text-[8px] text-[#00e5ff] tracking-[0.2em]">DOBLE CONFIRMACIÓN</span>
              </div>
              <div className="font-sharetech text-[8px] text-[#5a8898]">Técnico clásico + Multi-timeframe</div>
              {cachedAt && (
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex flex-col items-end gap-1.5">
                          ...
                          {typeof sig.iaConfianza === "number" && (
                            <span className="font-space text-[9px] font-bold px-2.5 py-1 tracking-[0.08em]"
                              style={{background:"#00e5ff18", border:"1px solid #00e5ff45", color:"#00e5ff"}}>
                              🦄 IA CONFIRMA {sig.iaConfianza.toFixed(0)}%
                            </span>
                          )}
                        </div>
                      </div>
                      ...
                      {sig.iaDictamen && (
                        <div className="mb-2.5 px-3 py-2 text-[11px] leading-relaxed text-[#b0bec5]"
                          style={{ background: "#0a0f16", borderLeft: "2px solid #00e5ff" }}>
                          {sig.iaDictamen}
                          {sig.iaPatron ? <span className="text-[#00e5ff] font-bold ml-2">· {sig.iaPatron}</span> : null}
                        </div>
                      )}
