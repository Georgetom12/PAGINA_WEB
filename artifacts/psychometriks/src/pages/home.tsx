    ...
    <div className="relative min-h-screen text-white bg-background overflow-x-hidden font-rajdhani z-10">
      ...
      <nav className="fixed top-0 w-full z-40 px-6 md:px-12 py-5 flex items-center justify-between bg-gradient-to-b from-[#020408]/95 to-transparent backdrop-blur-md">
        ...
        <div className="hidden md:flex gap-8 items-center">
          <a href="#features" className="font-space text-[11px] text-[#7ab3c8] tracking-[0.15em] uppercase hover:text-[#00e5ff] transition-colors">Suite</a>
          <a href="/indicators" className="font-space text-[11px] text-[#7ab3c8] tracking-[0.15em] uppercase hover:text-[#00e5ff] transition-colors">Indicadores</a>
          <a href="/blog" className="font-space text-[11px] text-[#7ab3c8] tracking-[0.15em] uppercase hover:text-[#00e5ff] transition-colors">Blog</a>
          <a href="/pricing" className="font-space text-[11px] text-[#7ab3c8] tracking-[0.15em] uppercase hover:text-[#00e5ff] transition-colors">Planes</a>
          <a href="/descarga" className="font-space text-[11px] text-[#00e5ff] tracking-[0.15em] uppercase hover:text-white transition-colors flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-[#00e5ff] animate-pulse" />📲 App
          </a>
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 pt-32 pb-20 relative overflow-hidden">
        ...
        <h1 className="font-bebas text-[clamp(62px,9vw,128px)] leading-[0.92] tracking-[0.01em] mb-4 relative z-10">
          DESCUBRÍ CÓMO<br />
          <span className="text-[#00e5ff]">PENSÁS</span> AL TRADEAR<br />
          <span className="text-[#7ab3c8]">Y EVITÁ LIQUIDACIONES</span>
        </h1>
      ...
      <section className="relative px-6 md:px-12 py-20 border-b border-[#1a2535] overflow-hidden">
        ...
        <div className="relative z-10 text-center mb-12">
          <div className="inline-flex items-center gap-2 font-space text-[10px] text-[#ffd700] tracking-[0.4em] uppercase mb-4 border border-[#ffd70022] px-4 py-1.5">
            ...
            NUEVO · GRATIS · SIN TARJETA
          </div>
          <h2 className="font-bebas text-[clamp(48px,7vw,96px)] leading-none text-white">
            OPERÁ EN <span className="text-[#ffd700]">DeFi</span><br />
            DESDE TU CUENTA
          </h2>
          <p className="font-space text-[13px] text-[#7ab3c8] mt-4 max-w-lg mx-auto leading-relaxed">
            Creá tu cuenta gratis y accedé a PSY Exchange y PSY Wallet — sin suscripción, sin tarjeta de crédito.
          </p>
        </div>

        {/* Cards */}
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-5 max-w-3xl mx-auto mb-10">
          {/* Exchange Card */}
          <Link href="/exchange"
