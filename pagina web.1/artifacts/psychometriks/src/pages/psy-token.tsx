...
export default function PsyToken() {
  ...
  const totalPct = TOKENOMICS.reduce((s, t) => s + t.pct, 0);
    ...
    <div className="min-h-screen bg-[#020b12] text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="border border-[#ffd70040] bg-[#0a0900] p-4 mb-10 flex items-center gap-4">
          ...
          <button className="shrink-0 px-4 py-2 font-sharetech text-[9px] tracking-[0.15em] border border-[#ffd700] text-[#ffd700] hover:bg-[#1a1400] transition-colors">
            WHITELIST
          </button>
        </div>
        ...
        <div className="mt-10 border border-[#e040fb30] bg-[#0a0012] p-8 text-center">
          ...
          <div className="flex gap-3 justify-center">
            <button className="px-8 py-3 bg-[#e040fb] text-black font-bebas text-xl tracking-widest hover:bg-[#ea6bfb] transition-colors">
              UNIRME A WHITELIST
            </button>
