...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "🌕 PSY LAUNCH — Lanza tu propio token en BSC · Bonding curve · Graduación automática a PancakeSwap · Fee 1% por trade",
  ...
  },
  {
    ...
    features: [
      ...
      "⚡ Scanner PRO Ilimitado — Análisis profundo de contratos: flags detallados, Whale Intel, detección de bots y honeypots — sin límite diario",
      "⬡ DeGate On-Chain — Order book ETH en vivo, gemas DEX, señales whale >$50K (ZK-Rollup Ethereum)",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "🏛 Equities Command Center v2.0 — Top 20 stocks · análisis técnico · macro correlaciones",
      "🔬 Buffett Scanner — Score Graham-Buffett por P/E + ROE + D/E + EPS Growth + Dividendo",
      "🕵️ Insider Trading — Transacciones SEC Form 4 · ejecutivos + directivos · sentimiento neto",
      "💰 Dividendos Screener — Yield · Aristocrats · calculadora de ingresos · payout safety",
