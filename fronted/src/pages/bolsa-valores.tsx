    ...
    <div className="min-h-screen bg-[#020b12] text-white">
      ...
      <div className="px-4 py-6 max-w-screen-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3">
          <Link href="/dashboard">
            <button className="flex items-center gap-1.5 text-[#0ff2]/60 hover:text-[#0ff2] transition-colors font-mono text-[10px] tracking-widest border border-[#0ff2]/20 hover:border-[#0ff2]/50 px-3 py-1.5 rounded">
              ← DASHBOARD
            </button>
          </Link>
