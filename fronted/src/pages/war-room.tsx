      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 pt-6 pb-8">
        ...
        <div className="flex items-center justify-between mb-6 pt-2">
          <div className="flex items-center gap-4">
            <Link href="/dashboard">
              <button className="font-sharetech text-[9px] tracking-[0.15em] text-[#7ab3c8] hover:text-[#00e5ff] transition-colors border border-[#0d2030] hover:border-[#00e5ff]/40 px-3 py-1.5">
                ← DASHBOARD
              </button>
            </Link>
